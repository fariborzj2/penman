...
- **بخش ثبت تغییرات (Change Log):**
  ...
  - **[2026-10-23T12:00:00Z]**: اصلاح پلاگین `ListPlugin` و `FormatPlugin` جهت استفاده مجدد از `execCommand` مرورگر، به دلیل نقص‌های جبران‌ناپذیرِ پیاده‌سازی دستی در هندل کردن همپوشانی‌های DOM و حفظ Selection.
...
- **بخش ثبت تغییرات (Change Log):**
  ...
  - **[2026-10-23T12:00:00Z]**: حل مشکلات و گپ‌های گزارش‌شده: حذف Mock progress آپلود عکس، اعمال دقیق قانون Trust Immutability برای تصاویر، تایید اجرا بدون Mock تمامی سناریوها در E2E Playwright.
