        ...
        body: `
          <div style="padding: 15px">
            <div class="penman-modal-form-row">
              <input type="url" id="penman-link-url" name="url" placeholder=" " required>
              <label for="penman-link-url">URL</label>
            </div>
            <div class="penman-modal-form-row ${currentText ? 'has-value' : ''}">
              <input type="text" id="penman-link-text" name="text" placeholder=" " value="${currentText}">
              <label for="penman-link-text">Text to display</label>
            </div>
            <div style="margin-top: 10px; display: flex; gap: 10px;">
              <div class="penman-modal-form-row" style="flex: 1; margin-bottom: 0;">
                <select id="penman-link-target" name="target">
              ...
              <div class="penman-modal-form-row" style="flex: 1; margin-bottom: 0;">
                <input type="text" id="penman-link-rel" name="rel" placeholder=" ">
                <label for="penman-link-rel">Rel (e.g. nofollow)</label>
              </div>
            </div>
          </div>
        `,
