...
export default {
  ...
  "rules": {
    ...
    "seo-content-empty": {
      ...
      "desc": "ادیتور هیچ متنی برای بررسی ندارد.",
      "why": "بدون محتوا، صفحه نه برای کاربر و نه برای موتورهای جستجو ارزشی ندارد و کیفیت آن صفر در نظر گرفته می‌شود.",
      "fix": "محتوای مرتبط و معنادار به سند اضافه کنید."
    },
