...
export class Sanitizer {
  constructor(editor = null) {
    ...
    this.allowedTags = {
      ...
      img: ["src", "alt", "width", "height", "data-id", "loading", "decoding", "fetchpriority", "draggable"],
      iframe: ["src", "title", "frameborder", "allow", "loading", "width", "height", "style"],
      video: ["src", "poster", "title", "controls", "autoplay", "muted", "preload", "width", "height", "style"],
      audio: ["src", "title", "controls", "autoplay", "muted", "preload", "width", "height", "style"],
