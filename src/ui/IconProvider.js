export class IconProvider {
  constructor() {
    ...
    this.icons = {
      ...
      superscript: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m4 19 8-8"/><path d="m12 19-8-8"/><path d="M20 12h-4c0-1.1.9-2 2-2a2 2 0 0 0 1.8-1.1c.1-.3.2-.6.2-.9a2 2 0 0 0-2-2 2 2 0 0 0-2 2"/></svg>',
      subscript: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m4 5 8 8"/><path d="m12 5-8-8"/><path d="M20 19h-4c0-1.1.9-2 2-2a2 2 0 0 0 1.8-1.1c.1-.3.2-.6.2-.9a2 2 0 0 0-2-2 2 2 0 0 0-2 2"/></svg>',
